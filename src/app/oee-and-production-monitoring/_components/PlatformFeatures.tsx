...
// images
import fiverrImg from "@/src/assets/images/productivitymntrngimage.svg";
...
function PlatformFeatures() {
  const featuresCardData = [
    {
      icon: iconOne,
      title: "Machine Utilization Trends",
      description:
        "Monitor machine utilization trends across your entire facility",
    },
    {
      icon: iconOne,
      title: "Performance Tracking",
      description: "Track performance against target zones and benchmarks",
    },
    {
      icon: iconOne,
      title: "Spotting Inefficiencies",
      description: "Identify inefficiencies and bottlenecks instantly",
    },
    {
      icon: iconOne,
      title: "Data-Driven Decisions",
      description:
        "Make data-driven decisions with comprehensive dashboard views",
    },
  ];
  return (
    <>
        ...
        <div className="2xl:py-[100px] xl:py-[75px] lg:py-[66px] md:py-[45px] py-[50px] 2xl:px-[72px] xl:px-[54px] lg:px-[48px] px-[20px]">
          <div className="flex justify-between items-start md:flex-nowrap flex-wrap md:gap-y-0 gap-y-[20px]">
            ...
            <div className="text-[#4B5563] font-medium leading-snug w-full 2xl:max-w-[771.19px] xl:max-w-[578px] lg:max-w-[514px] md:max-w-[420px] 2xl:text-[24px] xl:text-[18px] text-base">
              Convert complex production data into clear operational advantages
              with our comprehensive machine monitoring platform. Get real-time
              visibility, downtime analysis, and automated reporting to optimize
              your manufacturing efficiency and maximize equipment
              effectiveness.
