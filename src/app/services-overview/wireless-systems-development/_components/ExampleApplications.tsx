...
// images
import valueCulturedImg from '@/src/assets/images/Image (2).jpeg';
...
interface ListDataItem {
  ...
  const ExampleApplications: React.FC<ExampleApplicationsProps> = ({}) => {
    const listData: ListDataItem[] = [
        {leftTitle:'Industrial IoT Networks',rightDes:'Attitude and willingness to learn are greater anpssets than aptitude and experience',
            cardList:[
                {pointName:'Multi-node sensor networks'},
                {pointName:'Remote monitoring systems'},
                {pointName:'Asset tracking solutions'},
                {pointName:'Industrial control networks'},
                {pointName:'Predictive maintenance systems'},
            ]            
        },
        {leftTitle:'Remote Control Systems',rightDes:'We unite diverse engineering disciplines and approaches under one roof',
            cardList:[
                {pointName:'Wireless control panels'},
                {pointName:'Remote operation interfaces'},
                {pointName:'Emergency stop systems'},
                {pointName:'Mobile equipment controls'},
                {pointName:'Building automation systems'},
            ] 
        },
        {leftTitle:'Data Collection Networks',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'Environmental monitoring'},
                {pointName:'Process data acquisition'},
                {pointName:'Quality control systems'},
                {pointName:'Scientific data collection'},
                {pointName:'Health monitoring systems'},
            ] 
        },
    ]
