...
// images
import valueCulturedImg from '@/src/assets/images/Image (4).jpeg';
...
interface ListDataItem {
  ...
  const ExampleApplications: React.FC<ExampleApplicationsProps> = ({}) => {
    const listData: ListDataItem[] = [
        {leftTitle:'Industrial Enclosures',rightDes:'Attitude and willingness to learn are greater assets than aptitude and experience',
            cardList:[
                {pointName:'Control panel housings'},
                {pointName:'Equipment enclosures'},
                {pointName:'Junction box designs'},
                {pointName:'Operator interface housings'},
                {pointName:'Sensor housings'},
                {pointName:'Gateway enclosures'},
            ]            
        },
        {leftTitle:'Scientific Instruments',rightDes:'We unite diverse engineering disciplines and approaches under one roof',
            cardList:[
                {pointName:'Precision instrument housings'},
                {pointName:'Laboratory equipment design'},
                {pointName:'Measurement device enclosures'},
                {pointName:'Optical system integration'},
                {pointName:'Cooling system design'},
                {pointName:'Vibration isolation'},
            ] 
        },
        {leftTitle:'Consumer Products',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'Product housing design'},
                {pointName:'User interface integration'},
                {pointName:'Assembly optimization'},
                {pointName:'Aesthetic development'},
                {pointName:'Cost optimization'},
            ] 
        },
    ]
