...
// images
import valueCulturedImg from '@/src/assets/images/Image (7).jpeg';
...
interface ListDataItem {
  ...
  const ExampleApplications: React.FC<ExampleApplicationsProps> = ({}) => {
    const listData: ListDataItem[] = [
        {leftTitle:'Industrial Control Panels',rightDes:'Attitude and willingness to learn are greater assets than aptitude and experience',
            cardList:[
                {pointName:'Machine control interfaces'},
                {pointName:'Process monitoring displays'},
                {pointName:'Production line controls'},
                {pointName:'Equipment status panels'},
                {pointName:'Maintenance interfaces'},
            ]            
        },
        {leftTitle:'Scientific Instruments',rightDes:'We unite diverse engineering disciplines and approaches under one roof',
            cardList:[
                {pointName:'Measurement system interfaces'},
                {pointName:'Analysis tool controls'},
                {pointName:'Calibration interfaces'},
                {pointName:'Data visualization systems'},
                {pointName:'Parameter adjustment panels'},
            ] 
        },
        {leftTitle:'Connected Devices',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'IoT device controls'},
                {pointName:'Remote monitoring interfaces'},
                {pointName:'Smart appliance displays'},
                {pointName:'System configuration panels'},
                {pointName:'Status monitoring systems'},
            ] 
        },
        {leftTitle:'Technologies & Tools',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'Graphics development frameworks'},
            ] 
        },
    ]
