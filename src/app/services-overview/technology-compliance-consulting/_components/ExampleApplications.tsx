...
// images
import valueCulturedImg from '@/src/assets/images/Image (6).jpeg';
...
interface ListDataItem {
  ...
  const ExampleApplications: React.FC<ExampleApplicationsProps> = ({}) => {
    const listData: ListDataItem[] = [
        {leftTitle:'Medical Device Development',rightDes:'Attitude and willingness to learn are greater assets than aptitude and experience',
            cardList:[
                {pointName:'Safety standard compliance'},
                {pointName:'Risk management systems'},
                {pointName:'Technical documentation'},
                {pointName:'Quality system implementation'},
                {pointName:'Regulatory submission support'},
            ]            
        },
        {leftTitle:'Industrial Equipment',rightDes:'We unite diverse engineering disciplines and approaches under one roof',
            cardList:[
                {pointName:'Machine safety standards'},
                {pointName:'EMC compliance'},
                {pointName:'Environmental standards'},
                {pointName:'Quality system implementation'},
                {pointName:'Technical file preparation'},
            ] 
        },
        {leftTitle:'Consumer Electronics',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'Safety certification'},
                {pointName:'EMC compliance'},
                {pointName:'Wireless certification'},
                {pointName:'Environmental compliance'},
                {pointName:'Quality assurance systems'},
            ] 
        },
        {leftTitle:'Technologies & Tools',rightDes:'We go beyond service provision to become trusted advisors, sharing our experience and insights',
            cardList:[
                {pointName:'EMC/EMI testing equipment'}
            ] 
        },
    ]
